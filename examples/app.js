...
/***/ function(module, exports, __webpack_require__) {
	...
	var props = {
	    markers: ["January", "February", "March", "April", "May"],
	    startMarker: false,
	    endMarker: false,
	    endGradient: false,
	    percent: 60,
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Component = React.createClass({
	    ...
	    createLine: function createLine(i, lineStyle) {
	        return React.createElement("div", { className: "itsa-progressline-line",
	            key: i,
	            style: lineStyle });
	    },
	    createMarker: function createMarker(iKey, iMarker, linePercent, percent, shadedPercent) {
	        var checked = linePercent <= percent,
	            checkedShaded = shadedPercent && linePercent <= shadedPercent,
	            props = this.props;
	        var classname = MAIN_CLASS_PREFIX + "marker",
	            backwardsFill = void 0;
	        if (checked || checkedShaded) {
	            ...
	            if (props.endGradient && (iMarker > 0 || !props.startMarker)) {
	                backwardsFill = React.createElement("div", { className: MAIN_CLASS__LINEPREFIX + "backwardsfill" });
	            }
	        }
	        return React.createElement(
	            "div",
	            { className: MAIN_CLASS_PREFIX + "item", key: iKey },
	            React.createElement("div", { className: classname }),
	            React.createElement("div", { className: MAIN_CLASS_PREFIX + "label",
	    ...
	    render: function render() {
	        var items = [],
	            ...
	            lines = void 0,
	            shadedLine = void 0,
	            endGradientShaded = void 0,
	            lineStyleChecked = void 0,
	            startGradient = void 0,
	            endGradient = void 0,
	            lineStyleCheckedShaded = void 0;
	        var instance = this,
	        ...
	        if (!startMarker && percent > 0 && props.startGradient) {
	            startGradient = React.createElement("div", { className: MAIN_CLASS__LINEPREFIX + 'startgradient' });
	        }
	        ...
	        if (shadedPercent) {
	            ...
	            shadedLine = React.createElement(
	                "div",
	                { className: MAIN_CLASS__LINEPREFIX + 'checked ' + MAIN_CLASS__LINEPREFIX + 'transparent', style: lineStyleCheckedShaded },
	                endGradientShaded
	            );
	        }
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { className: MAIN_CLASS__LINEPREFIX + 'checked', style: lineStyleChecked },
	                endGradient,
	                startGradient
	            ),
	            items
